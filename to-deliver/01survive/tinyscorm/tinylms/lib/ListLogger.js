 ...
 * @version 2,9 2008-10-21 Rewrote using prototype functions instead of global
 * functions.
 * 1.2 2006-06-21 Moved all styles of TinyLMS into a single stylesheet.
...
ListLogger.prototype.open = function() {
	if ((!this.logWindow) || (this.logWindow.closed)) {
		...
		navTempText += "      <link href=\""+this.topURL+"tinylms/style/style.css\" rel=\"stylesheet\" type=\"text/css\">\n";
...
ListLogger.prototype.close = function() {
	if (this.logWindow) {
...
ListLogger.prototype.write = function(type, message) {
	if (type <= this.level) {
    	this.open();
 ...
 */
ListLogger.prototype.scrollDown = function() {
 ...
 * function ListLogger.write.
 */
var LoggerSingleton = new ListLogger();